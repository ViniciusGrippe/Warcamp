...
const bg = PIXI.Sprite.fromImage(
...
const logo = PIXI.Sprite.fromImage("https://i.imgur.com/8Z58Jha.png");
logo.width = window.autoDetectRenderer;
logo.height = 718;
logo.x = window.innerWidth / 2;
logo.y = window.innerHeight / 1.7;
logo.anchor.set(0.5);
